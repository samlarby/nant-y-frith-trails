...
class StripeWh_handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        subject = render_to_string(
            'checkout/confirmatio_emails/confirmation_email_subject.txt',
            {'order': order})
        body = render_to_string(
            'checkout/confirmatio_emails/confirmation_email_body.txt',
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonynousUser':
            ...
            if save_info():
                ...
                profile.default_gra = grand_total,
                profile.default_orig = bag,
                profile.default_st = pid,
                profile.save()
